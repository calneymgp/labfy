...
const mainNav = [
  ...
  { title: "Projetos", href: "/v6#projetos", icon: Box },
  { title: "Roadmap", href: "/v6#roadmap", icon: Map },
  { title: "Blog", href: "/v6#blog", icon: BookOpen },
];

const projectsNav = [
  { title: "TAMZ", href: "#", icon: Folder },
  { title: "Escudo Code", href: "#", icon: Shield },
  { title: "Loot Hunter", href: "#", icon: FlaskConical },
];
    ...
    <Sidebar variant="inset">
      <SidebarHeader>
        <div className="flex items-center gap-2 px-2 py-1.5">
          <div className="flex h-6 w-6 items-center justify-center rounded-sm bg-foreground text-background text-xs font-bold">
            L
          </div>
          <span className="font-semibold tracking-tight">Labfy</span>
        </div>
      </SidebarHeader>
      <SidebarContent>
        <SidebarGroup>
