...
export default function HomePage() {
  return (
    <div className="mx-auto flex max-w-5xl flex-1 items-center py-4">
      <section className="flex w-full flex-col items-center justify-center gap-8 rounded-sm border border-border bg-black px-6 py-24 text-center sm:py-32">
        <Image
          src="/labfy-logo.png"
          alt="Labfy"
          width={200}
