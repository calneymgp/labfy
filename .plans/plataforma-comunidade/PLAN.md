...
- 2026-07-14 — UI War Room refinada: layout de chat (prompt input fixo embaixo estilo ChatGPT/Claude com Textarea+Button shadcn, Enter envia/Shift+Enter quebra linha, auto-scroll até a última fala) + vídeo com zoom out (object-contain), menor (max-w-sm) e centralizado. Gate verde. Smoke visual pendente do usuário (rota exige login calneymgp@gmail.com).
